...
<div id="wrapper" class="wrapper">
                    ...
                    <div class="dignity-item col col_4 col_mob-12">
                        <div class="dignity-block">
                            ...
                            <div class="dignity-description wysiwyg">
                                <p>"Aventura a Medida"
                                    Diseña tu propia jornada de pesca con nuestras excursiones personalizadas. Elige tus fechas y ajusta la experiencia según tus preferencias y las condiciones óptimas de pesca.</p>
                            </div>
                        </div>
                    </div>
                    <div class="dignity-item col col_4 col_mob-12">
                        <div class="dignity-block">
                            ...
                            <div class="dignity-description wysiwyg">
                                <p>"Explora los Ríos del Nordeste"
                                    Sumérgete en la belleza natural de Pernambuco y Paraíba, con acceso a ríos únicos y paisajes impresionantes que ofrecen las mejores oportunidades para la pesca deportiva.</p>
                            </div>
                        </div>
                    </div>
                    <div class="dignity-item col col_4 col_mob-12">
                        <div class="dignity-block">
                            ...
                            <div class="dignity-description wysiwyg">
                                <p>"Embarcaciones Equipadas"
                                    Disfruta de pesca con total comodidad y seguridad en nuestras embarcaciones de última generación, diseñadas para ofrecerte una experiencia de pesca inolvidable en las mejores condiciones.</p>
                            </div>
                        </div>
                    </div>
        ...
        <section id="rios" class="section">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col col_6 col_desktop-12">
                        <h2 class="h2 emotional-title">Disfruta de los mejores paisajes</h2>
                        <div class="emotional-list">
                            ...
                            <div class="emotional-item">
                                <div class="emotional-block">
                                    ...
                                    <div class="emotional-info">
                                        <h3 class="h3 emotional-subtitle">Rio Ipojucas</h3>
                                        <div class="emotional-description wysiwyg">
                                            <p>Situado cerca de Porto de Galinhas, famoso por sus playas cristalinas y piscinas naturales. El río, rodeado de manglares, permite la pesca en aguas más tranquilas y ofrece una experiencia tanto de pesca deportiva como de relax, ideal para aquellos que buscan combinar la pesca con el disfrute de la naturaleza.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="emotional-item">
                                <div class="emotional-block">
                                    ...
                                    <div class="emotional-info">
                                        <h3 class="h3 emotional-subtitle">Rio Jaboatão</h3>
                                        <div class="emotional-description wysiwyg">
                                            <p>Ubicado entre Recife y Porto de Galinhas, este río presenta una mezcla de estructuras rocosas y manglares, ofreciendo un excelente lugar para la pesca de tarpons y robalos. Además, la zona cuenta con infraestructuras para descansar, como marinas con restaurantes y piscinas.​ </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col col_6 col_desktop-12">
                        <div class="description-container">
                            <div class="wysiwyg">
                                ...
                                <p>En Silver King Brazil, somos pioneros en la pesca de tarpon en la costa nordestina de Brasil. Con años de experiencia, ofrecemos emocionantes excursiones en Pernambuco y Paraíba, dos de los destinos más prometedores para esta especie en Sudamérica. </p>
                                <p>Nuestros guías expertos te llevarán a pescar en ríos rodeados de manglares y formaciones rocosas, usando embarcaciones completamente equipadas para garantizar tu comodidad y seguridad. La pesca se realiza principalmente a pez visto, aprovechando los momentos más productivos del día, entre las 5 AM y las 8 AM, y de
                                    3 PM a 5 PM, adaptándonos a las mareas para obtener los mejores resultados.</p>
                                <ol>
                ...
                <div class="row">
                    ...
                    <div class="col col_8 col_desktop-12">
                        <div class="subscript-title text-center" id="brochure">
                            ...
                            <h3 class="h3 title">Dejanos tu email y recibí el brochure 2024</h3>
                        </div>
                            ...
                            <div class="form-field ">
                                <div class="form-group">
                                    <label class="label-wrap" for="subscription_email">
                                        <input id="subscription_email" type="email" placeholder="Tu dirección de email" name="subscription_email" required>
                                    </label>
    ...
    <footer id="footer" class="footer">
                        ...
                        <div class="col col_6 col_desktop-6 col_mob-12">
                            <div class="row">
                                ...
                                <div class="col col_10 col_desktop-12">
                                    <div class="subscript">
                                        <h3 class="subscript-title h3 text-center text-desktop-left text-mob-center">¿Nos ponemos en contacto?</h3>
                                            ...
                                            <div class="form-field ">
                                                <div class="form-group">
                                                    <label class="label-wrap label-icon label-icon-position-left" for="subscription_email-footer">
                                                        <input id="subscription_email-footer" type="email" placeholder="Tu dirección de email" name="subscription_email-footer" required>
        ...
        <div class="footer-bottom">
            <div class="container">
                <span class="copyright text-center">"Silver King Brazil, conectando pasión y naturaleza"</span>
            </div>
        </div>
    </footer>
